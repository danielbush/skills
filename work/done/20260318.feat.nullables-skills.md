...
outcome: Built two skills (nullables-refactor, nullables-test) and a shared vocabulary layer. Refactor skill eval'd at 95.8% vs 88.5% baseline. Outstanding evals for test skill, AAA pattern encoding, and /explain-nullables never started. Approach is being superseded — moving from upfront vocab-heavy skills to smaller, concrete, individually-activatable skills. Remaining ideas carry forward into new ticket.
---
...
2. ~~**Test level**~~ — ✅ added to Philosophy section: build confidence from the top down, drop to lower levels as needed
3. ~~**Instantiation**~~ — ✅ already in SKILL.md (line 69+)
