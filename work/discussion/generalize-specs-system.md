...
2. **Vocabulary awareness** — `/summarize` references jsed vocabulary. Generalized version should use whatever vocabulary exists in the project's `docs/vocab/` (ties back to Theme 1).
