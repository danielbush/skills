...
status: active
created: 2026-03-17
summary: Define a standard set of project files (AGENTS.md, PRD.md, SESSIONS.md, TODO.md, specs/) that together give an agent full continuity across sessions and alignment with the human on goals, principles, progress, and reasoning
...
| **specs/** | Institutional memory — why things were done, decisions, reasoning | Both (searched on demand) | Written per session via /summarize |
...
SESSIONS.md     ← what did we do? (session log, "let's continue")
  ↓
specs/          ← why did we do it? (decisions, reasoning)
